...
#ifndef RTW_HEADER_huamo_types_h_
#define RTW_HEADER_huamo_types_h_
#include "rtwtypes.h"

/* Parameters for system: '<S2>/Angle_hold' */
typedef struct P_Angle_hold_huamo_T_ P_Angle_hold_huamo_T;

/* Parameters for system: '<Root>/Guidance_System' */
typedef struct P_Guidance_System_huamo_T_ P_Guidance_System_huamo_T;

/* Parameters (auto storage) */
typedef struct P_huamo_T_ P_huamo_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_huamo_T RT_MODEL_huamo_T;

#endif                                 /* RTW_HEADER_huamo_types_h_ */
