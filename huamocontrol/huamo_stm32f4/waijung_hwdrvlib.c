...
void enable_dianjiBasicPWM7(void)
{
  /* Block: dianjiBasicPWM7 */
  GPIO_InitTypeDef GPIO_InitStructure;
  ...
  TIM_TimeBaseStructure.TIM_Period = dianjiBasicPWM7_TIM4_ARR-1;/* 0.01 sec */
...
void disable_dianjiBasicPWM7(void)
{
  TIM_Cmd(TIM4, DISABLE);
}

void terminate_dianjiBasicPWM7(void)
{
  TIM_Cmd(TIM4, DISABLE);
}
...
/* ########################################################################
 * Name: <S11>/UART Tx2
 * Id: toshangweijiUARTTx2
 * ########################################################################
 */

/* Enable UART-DMA module */
void enable_toshangweijiUARTTx2(void)
{
}
