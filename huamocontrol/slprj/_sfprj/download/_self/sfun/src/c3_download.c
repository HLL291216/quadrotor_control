...
static const char * c3_debug_family_names[9] = { "b", "d", "U", "mapmat", "bin",
  "nargin", "nargout", "in", "out" };

/* Function Declarations */
static void initialize_c3_download(SFc3_downloadInstanceStruct *chartInstance);
static void initialize_params_c3_download(SFc3_downloadInstanceStruct
  *chartInstance);
static void enable_c3_download(SFc3_downloadInstanceStruct *chartInstance);
static void disable_c3_download(SFc3_downloadInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_download(SFc3_downloadInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_download(SFc3_downloadInstanceStruct
  *chartInstance);
static void set_sim_state_c3_download(SFc3_downloadInstanceStruct *chartInstance,
  const mxArray *c3_st);
static void finalize_c3_download(SFc3_downloadInstanceStruct *chartInstance);
static void sf_gateway_c3_download(SFc3_downloadInstanceStruct *chartInstance);
static void initSimStructsc3_download(SFc3_downloadInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_downloadInstanceStruct *chartInstance,
  const mxArray *c3_out, const char_T *c3_identifier, real_T c3_y[4]);
static void c3_b_emlrt_marshallIn(SFc3_downloadInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[4]);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_downloadInstanceStruct *chartInstance,
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_d_emlrt_marshallIn(SFc3_downloadInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[4]);
...
static void c3_eps(SFc3_downloadInstanceStruct *chartInstance);
static real_T c3_norm(SFc3_downloadInstanceStruct *chartInstance, real_T c3_x[16]);
static void c3_eml_warning(SFc3_downloadInstanceStruct *chartInstance);
static void c3_b_eml_warning(SFc3_downloadInstanceStruct *chartInstance, char_T
  c3_varargin_2[14]);
static void c3_eml_scalar_eg(SFc3_downloadInstanceStruct *chartInstance);
static void c3_eml_xgemm(SFc3_downloadInstanceStruct *chartInstance, real_T
  c3_A[16], real_T c3_B[4], real_T c3_C[4], real_T c3_b_C[4]);
static void c3_e_emlrt_marshallIn(SFc3_downloadInstanceStruct *chartInstance,
  const mxArray *c3_sprintf, const char_T *c3_identifier, char_T c3_y[14]);
static void c3_f_emlrt_marshallIn(SFc3_downloadInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, char_T c3_y[14]);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_g_emlrt_marshallIn(SFc3_downloadInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_h_emlrt_marshallIn(SFc3_downloadInstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_download, const char_T *c3_identifier);
static uint8_T c3_i_emlrt_marshallIn(SFc3_downloadInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_eml_xgemm(SFc3_downloadInstanceStruct *chartInstance, real_T
  c3_A[16], real_T c3_B[4], real_T c3_C[4]);
static void init_dsm_address_info(SFc3_downloadInstanceStruct *chartInstance);
...
static void initialize_c3_download(SFc3_downloadInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_download = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c3_out)[4];
  c3_out = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_download;
  ...
  const mxArray *c3_st)
{
  ...
  c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 0)), "out",
                      c3_dv0);
  for (c3_i1 = 0; c3_i1 < 4; c3_i1++) {
    (*c3_out)[c3_i1] = c3_dv0[c3_i1];
  }

  chartInstance->c3_is_active_c3_download = c3_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 1)), "is_active_c3_download");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_download(chartInstance);
...
static void sf_gateway_c3_download(SFc3_downloadInstanceStruct *chartInstance)
{
  ...
  int32_T c3_i4;
  int32_T c3_i5;
  static real_T c3_x[16] = { 8.7838E-6, 0.0, -8.7838E-6, 7.5E-7, 8.7838E-6,
    -8.7838E-6, 0.0, -7.5E-7, 8.7838E-6, 0.0, 8.7838E-6, 7.5E-7, 8.7838E-6,
    8.7838E-6, 0.0, -7.5E-7 };

  int32_T c3_i6;
  real_T c3_b_x[16];
  real_T c3_n1x;
  int32_T c3_i7;
  static real_T c3_xinv[16] = { 28461.485917256767, 28461.485917256763,
  ...
  c3_b_out = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c3_b_in = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  for (c3_i2 = 0; c3_i2 < 4; c3_i2++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_in)[c3_i2], 0U);
  }

  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  for (c3_i3 = 0; c3_i3 < 4; c3_i3++) {
    c3_in[c3_i3] = (*c3_b_in)[c3_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 9U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b, 0U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_d, 1U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_U, 2U, c3_d_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_mapmat, 3U, c3_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_bin, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 6U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_in, 7U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_out, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c3_i5 = 0; c3_i5 < 16; c3_i5++) {
    c3_mapmat[c3_i5] = c3_x[c3_i5];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 18);
  for (c3_i6 = 0; c3_i6 < 16; c3_i6++) {
    c3_b_x[c3_i6] = c3_x[c3_i6];
  }

  c3_n1x = c3_norm(chartInstance, c3_b_x);
  for (c3_i7 = 0; c3_i7 < 16; c3_i7++) {
    c3_b_xinv[c3_i7] = c3_xinv[c3_i7];
  }

  c3_n1xinv = c3_norm(chartInstance, c3_b_xinv);
      ...
      c3_e_emlrt_marshallIn(chartInstance, sf_mex_call_debug
        ...
        sf_mex_call_debug(sfGlobalDebugInstanceStruct, "sprintf", 1U, 3U, 14,
                          c3_y, 14, c3_b_y, 14, c3_c_y), 14, c3_d_y), "sprintf",
                            c3_str);
      for (c3_i9 = 0; c3_i9 < 14; c3_i9++) {
        c3_b_str[c3_i9] = c3_str[c3_i9];
      }
  ...
  for (c3_i13 = 0; c3_i13 < 16; c3_i13++) {
    c3_dv1[c3_i13] = c3_xinv[c3_i13];
  }

  for (c3_i14 = 0; c3_i14 < 4; c3_i14++) {
    c3_dv2[c3_i14] = c3_c_b[c3_i14];
  }

  for (c3_i15 = 0; c3_i15 < 16; c3_i15++) {
    c3_dv3[c3_i15] = c3_dv1[c3_i15];
  }

  for (c3_i16 = 0; c3_i16 < 4; c3_i16++) {
    c3_dv4[c3_i16] = c3_dv2[c3_i16];
  }

  c3_b_eml_xgemm(chartInstance, c3_dv3, c3_dv4, c3_bin);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 20);
  for (c3_i17 = 0; c3_i17 < 4; c3_i17++) {
    c3_out[c3_i17] = c3_bin[c3_i17];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -20);
  _SFD_SYMBOL_SCOPE_POP();
  for (c3_i18 = 0; c3_i18 < 4; c3_i18++) {
    (*c3_b_out)[c3_i18] = c3_out[c3_i18];
  }
  ...
  for (c3_i19 = 0; c3_i19 < 4; c3_i19++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_out)[c3_i19], 1U);
  }
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u[4];
  const mxArray *c3_y = NULL;
  SFc3_downloadInstanceStruct *chartInstance;
  chartInstance = (SFc3_downloadInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c3_out, const char_T *c3_identifier, real_T c3_y[4])
{
  ...
  c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_out), &c3_thisId, c3_y);
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i23 = 0; c3_i23 < 4; c3_i23++) {
    (*(real_T (*)[4])c3_outData)[c3_i23] = c3_y[c3_i23];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_U), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_U);
...
const mxArray *sf_c3_download_get_eml_resolved_functions_info(void)
{
  const mxArray *c3_nameCaptureInfo = NULL;
  c3_nameCaptureInfo = NULL;
  sf_mex_assign(&c3_nameCaptureInfo, sf_mex_createstruct("structure", 2, 156, 1),
                false);
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("inv"), "name", "name", 0);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/eml_xgetrf.m"),
                  "resolved", "resolved", 2);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1286826006U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/internal/eml_lapack_xgetrf.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1286826010U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1302696194U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 5);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("realmin"), "name", "name", 5);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 8);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eps"), "name", "name", 8);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_eps"), "name", "name", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 12);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("min"), "name", "name", 12);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 21);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("colon"), "name", "name", 21);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1378303188U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("colon"), "name", "name", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("floor"), "name", "name", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 28);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("intmin"), "name", "name", 28);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
...
static void c3_b_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/ixamax.p!below_threshold"),
                  "context", "context", 64);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("length"), "name", "name", 64);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 64);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xcabs1.p"),
                  "context", "context", 68);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 68);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 68);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xswap.p"),
                  "context", "context", 79);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 79);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 84);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 84);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 84);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xger.p!below_threshold"),
                  "context", "context", 93);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("intmax"), "name", "name", 93);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 93);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xger.p!below_threshold"),
                  "context", "context", 94);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("min"), "name", "name", 94);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 94);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xgerx.p"),
                  "context", "context", 103);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 103);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_ipiv2perm.m"), "context",
                  "context", 109);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("colon"), "name", "name", 109);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 109);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1326731922U), "fileTimeLo",
                  "fileTimeLo", 111);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 111);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m!is_signed_indexIntClass"),
                  "context", "context", 114);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("intmin"), "name", "name", 114);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 114);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
...
static void c3_c_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 128);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("intmin"), "name", "name", 128);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 128);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xtrsm.p"),
                  "context", "context", 129);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("rdivide"), "name", "name", 129);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 129);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 132);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 132);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 132);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m!checkcond"),
                  "context", "context", 133);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("norm"), "name", "name", 133);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 133);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m!mat1norm"),
                  "context", "context", 135);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 135);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 135);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m!mat1norm"),
                  "context", "context", 136);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isnan"), "name", "name", 136);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 136);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m!checkcond"),
                  "context", "context", 141);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isnan"), "name", "name", 141);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 141);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m!checkcond"),
                  "context", "context", 142);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eps"), "name", "name", 142);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 142);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_flt2str.m"), "context",
                  "context", 144);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "name", "name", 144);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 144);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs144), "lhs", "lhs",
                  144);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(""), "context", "context", 145);
...
static void c3_eml_warning(SFc3_downloadInstanceStruct *chartInstance)
{
  ...
  const mxArray *c3_y = NULL;
  (void)chartInstance;
  for (c3_i34 = 0; c3_i34 < 27; c3_i34++) {
    c3_u[c3_i34] = c3_varargin_1[c3_i34];
  }
  ...
  c3_varargin_2[14])
{
  ...
  for (c3_i35 = 0; c3_i35 < 33; c3_i35++) {
    c3_u[c3_i35] = c3_varargin_1[c3_i35];
  }

  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 10, 0U, 1U, 0U, 2, 1, 33), false);
  for (c3_i36 = 0; c3_i36 < 14; c3_i36++) {
    c3_b_u[c3_i36] = c3_varargin_2[c3_i36];
  }
  ...
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, char_T c3_y[14])
{
  ...
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_cv1, 1, 10, 0U, 1, 0U, 2, 1,
                14);
  for (c3_i40 = 0; c3_i40 < 14; c3_i40++) {
    c3_y[c3_i40] = c3_cv1[c3_i40];
  }
  ...
  const mxArray *c3_b_is_active_c3_download, const char_T *c3_identifier)
{
  ...
  c3_y = c3_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_download), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_download);
  return c3_y;
}
...
void sf_c3_download_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4234825034U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4127772230U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1447877598U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2398288838U);
}

mxArray *sf_c3_download_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("HfarRlBqnwn5Iwrz9bbiBF");
...
mxArray *sf_c3_download_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_download_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_download(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[8],M[0],T\"is_active_c3_download\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_download_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_downloadInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c3_out)[4];
          c3_out = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
          c3_in = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 0);
...
{
  return "RzGKkSEFvysjJYXhxSTE9D";
}

static void sf_opaque_initialize_c3_download(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_downloadInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c3_download((SFc3_downloadInstanceStruct*) chartInstanceVar);
  initialize_c3_download((SFc3_downloadInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_download(void *chartInstanceVar)
{
  enable_c3_download((SFc3_downloadInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_download(void *chartInstanceVar)
{
  disable_c3_download((SFc3_downloadInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_download(void *chartInstanceVar)
{
  sf_gateway_c3_download((SFc3_downloadInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_download(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_download((SFc3_downloadInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_download();/* state var info */
...
extern void sf_internal_set_sim_state_c3_download(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_download();/* state var info */
  ...
  set_sim_state_c3_download((SFc3_downloadInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_download(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_download(S);
}

static void sf_opaque_set_sim_state_c3_download(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_download(S, st);
}

static void sf_opaque_terminate_c3_download(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_downloadInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_download((SFc3_downloadInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_download((SFc3_downloadInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_download(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_download((SFc3_downloadInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_download(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(672222142U));
  ssSetChecksum1(S,(1499712212U));
  ssSetChecksum2(S,(2063788037U));
  ssSetChecksum3(S,(531289587U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_download(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_download(SimStruct *S)
{
  SFc3_downloadInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_downloadInstanceStruct *)utMalloc(sizeof
    (SFc3_downloadInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_downloadInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_download;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_download;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_download;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_download;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_download;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_download;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_download;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_download;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_download;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_download;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_download;
...
void c3_download_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_download(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_download(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_download(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_download_method_dispatcher.\n"
