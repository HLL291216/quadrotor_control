...
static void initialize_c5_download(SFc5_downloadInstanceStruct *chartInstance);
static void initialize_params_c5_download(SFc5_downloadInstanceStruct
  *chartInstance);
static void enable_c5_download(SFc5_downloadInstanceStruct *chartInstance);
static void disable_c5_download(SFc5_downloadInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_download(SFc5_downloadInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_download(SFc5_downloadInstanceStruct
  *chartInstance);
static void set_sim_state_c5_download(SFc5_downloadInstanceStruct *chartInstance,
  const mxArray *c5_st);
static void finalize_c5_download(SFc5_downloadInstanceStruct *chartInstance);
static void sf_gateway_c5_download(SFc5_downloadInstanceStruct *chartInstance);
static void initSimStructsc5_download(SFc5_downloadInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_downloadInstanceStruct *chartInstance,
  const mxArray *c5_out, const char_T *c5_identifier, real_T c5_y[4]);
static void c5_b_emlrt_marshallIn(SFc5_downloadInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[4]);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_downloadInstanceStruct *chartInstance,
...
static void c5_eml_error(SFc5_downloadInstanceStruct *chartInstance);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_d_emlrt_marshallIn(SFc5_downloadInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_e_emlrt_marshallIn(SFc5_downloadInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_download, const char_T *c5_identifier);
static uint8_T c5_f_emlrt_marshallIn(SFc5_downloadInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_downloadInstanceStruct *chartInstance);
...
static void initialize_c5_download(SFc5_downloadInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_download = 0U;
}
  ...
  *chartInstance)
{
  ...
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_download;
  ...
  const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_download = c5_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)), "is_active_c5_download");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_download(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u[4];
  const mxArray *c5_y = NULL;
  SFc5_downloadInstanceStruct *chartInstance;
  chartInstance = (SFc5_downloadInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_download_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c5_b_is_active_c5_download, const char_T *c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_download), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_download);
  return c5_y;
}
...
void sf_c5_download_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_download_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_download_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_download_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_download(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[8],M[0],T\"is_active_c5_download\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_download_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_downloadInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c5_download(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_downloadInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c5_download((SFc5_downloadInstanceStruct*) chartInstanceVar);
  initialize_c5_download((SFc5_downloadInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_download(void *chartInstanceVar)
{
  enable_c5_download((SFc5_downloadInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_download(void *chartInstanceVar)
{
  disable_c5_download((SFc5_downloadInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_download(void *chartInstanceVar)
{
  sf_gateway_c5_download((SFc5_downloadInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_download(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_download((SFc5_downloadInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_download();/* state var info */
...
extern void sf_internal_set_sim_state_c5_download(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_download();/* state var info */
  ...
  set_sim_state_c5_download((SFc5_downloadInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_download(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_download(S);
}

static void sf_opaque_set_sim_state_c5_download(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_download(S, st);
}

static void sf_opaque_terminate_c5_download(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_downloadInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_download((SFc5_downloadInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_download((SFc5_downloadInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_download(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_download((SFc5_downloadInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_download(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_download(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_download(SimStruct *S)
{
  SFc5_downloadInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_downloadInstanceStruct *)utMalloc(sizeof
    (SFc5_downloadInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_downloadInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_download;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_download;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_download;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_download;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_download;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_download;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_download;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_download;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_download;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_download;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_download;
...
void c5_download_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_download(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_download(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_download(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_download_method_dispatcher.\n"
