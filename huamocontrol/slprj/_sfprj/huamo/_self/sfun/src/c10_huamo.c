...
static void initialize_c10_huamo(SFc10_huamoInstanceStruct *chartInstance);
static void initialize_params_c10_huamo(SFc10_huamoInstanceStruct *chartInstance);
static void enable_c10_huamo(SFc10_huamoInstanceStruct *chartInstance);
static void disable_c10_huamo(SFc10_huamoInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_huamo(SFc10_huamoInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c10_huamo(SFc10_huamoInstanceStruct
  *chartInstance);
static void set_sim_state_c10_huamo(SFc10_huamoInstanceStruct *chartInstance,
  const mxArray *c10_st);
static void finalize_c10_huamo(SFc10_huamoInstanceStruct *chartInstance);
static void sf_gateway_c10_huamo(SFc10_huamoInstanceStruct *chartInstance);
static void initSimStructsc10_huamo(SFc10_huamoInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_emlrt_marshallIn(SFc10_huamoInstanceStruct *chartInstance,
  const mxArray *c10_b_status, const char_T *c10_identifier);
static real_T c10_b_emlrt_marshallIn(SFc10_huamoInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_c_emlrt_marshallIn(SFc10_huamoInstanceStruct *chartInstance,
  const mxArray *c10_y, const char_T *c10_identifier);
static real_T c10_d_emlrt_marshallIn(SFc10_huamoInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_e_emlrt_marshallIn(SFc10_huamoInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_f_emlrt_marshallIn(SFc10_huamoInstanceStruct *chartInstance,
  const mxArray *c10_b_is_active_c10_huamo, const char_T *c10_identifier);
static uint8_T c10_g_emlrt_marshallIn(SFc10_huamoInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_huamoInstanceStruct *chartInstance);
...
static void initialize_c10_huamo(SFc10_huamoInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_huamo = 0U;
}
  ...
  *chartInstance)
{
  ...
  c10_c_hoistedGlobal = chartInstance->c10_is_active_c10_huamo;
  ...
  const mxArray *c10_st)
{
  ...
  *c10_y = c10_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c10_u,
  ...
  chartInstance->c10_is_active_c10_huamo = c10_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c10_u, 2)), "is_active_c10_huamo");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_huamo(chartInstance);
  ...
  *c10_inData)
{
  ...
  real_T c10_u;
  const mxArray *c10_y = NULL;
  SFc10_huamoInstanceStruct *chartInstance;
  chartInstance = (SFc10_huamoInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_huamo_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c10_b_is_active_c10_huamo, const char_T *c10_identifier)
{
  ...
  c10_y = c10_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_huamo), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_huamo);
  return c10_y;
}
...
void sf_c10_huamo_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_huamo_get_autoinheritance_info(void)
{
...
mxArray *sf_c10_huamo_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_huamo_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c10_huamo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[4],M[0],T\"status\",S'l','i','p'{{M1x2[45 51],M[0],}}},{M[8],M[0],T\"is_active_c10_huamo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_huamo_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_huamoInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c10_huamo(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_huamoInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c10_huamo((SFc10_huamoInstanceStruct*) chartInstanceVar);
  initialize_c10_huamo((SFc10_huamoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_huamo(void *chartInstanceVar)
{
  enable_c10_huamo((SFc10_huamoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_huamo(void *chartInstanceVar)
{
  disable_c10_huamo((SFc10_huamoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_huamo(void *chartInstanceVar)
{
  sf_gateway_c10_huamo((SFc10_huamoInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_huamo(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_huamo((SFc10_huamoInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_huamo();/* state var info */
...
extern void sf_internal_set_sim_state_c10_huamo(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c10_huamo();/* state var info */
  ...
  set_sim_state_c10_huamo((SFc10_huamoInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_huamo(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_huamo(S);
}

static void sf_opaque_set_sim_state_c10_huamo(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c10_huamo(S, st);
}

static void sf_opaque_terminate_c10_huamo(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_huamoInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_huamo((SFc10_huamoInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_huamo((SFc10_huamoInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_huamo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c10_huamo((SFc10_huamoInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c10_huamo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c10_huamo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_huamo(SimStruct *S)
{
  SFc10_huamoInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_huamoInstanceStruct *)utMalloc(sizeof
    (SFc10_huamoInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_huamoInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_huamo;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_huamo;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_huamo;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_huamo;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_huamo;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_huamo;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_huamo;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c10_huamo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_huamo;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_huamo;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_huamo;
...
void c10_huamo_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_huamo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_huamo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_huamo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_huamo_method_dispatcher.\n"
