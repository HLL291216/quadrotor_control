...
static void initialize_c3_huamo(SFc3_huamoInstanceStruct *chartInstance);
static void initialize_params_c3_huamo(SFc3_huamoInstanceStruct *chartInstance);
static void enable_c3_huamo(SFc3_huamoInstanceStruct *chartInstance);
static void disable_c3_huamo(SFc3_huamoInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_huamo(SFc3_huamoInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_huamo(SFc3_huamoInstanceStruct
  *chartInstance);
static void set_sim_state_c3_huamo(SFc3_huamoInstanceStruct *chartInstance,
  const mxArray *c3_st);
static void finalize_c3_huamo(SFc3_huamoInstanceStruct *chartInstance);
static void sf_gateway_c3_huamo(SFc3_huamoInstanceStruct *chartInstance);
static void initSimStructsc3_huamo(SFc3_huamoInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_huamoInstanceStruct *chartInstance, const
  mxArray *c3_out, const char_T *c3_identifier, real_T c3_y[4]);
static void c3_b_emlrt_marshallIn(SFc3_huamoInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[4]);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_huamoInstanceStruct *chartInstance,
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_d_emlrt_marshallIn(SFc3_huamoInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[4]);
...
static void c3_eps(SFc3_huamoInstanceStruct *chartInstance);
static real_T c3_norm(SFc3_huamoInstanceStruct *chartInstance, real_T c3_x[16]);
static void c3_eml_warning(SFc3_huamoInstanceStruct *chartInstance);
static void c3_b_eml_warning(SFc3_huamoInstanceStruct *chartInstance, char_T
  c3_varargin_2[14]);
static void c3_eml_scalar_eg(SFc3_huamoInstanceStruct *chartInstance);
static void c3_eml_xgemm(SFc3_huamoInstanceStruct *chartInstance, real_T c3_A[16],
  real_T c3_B[4], real_T c3_C[4], real_T c3_b_C[4]);
static void c3_e_emlrt_marshallIn(SFc3_huamoInstanceStruct *chartInstance, const
  mxArray *c3_sprintf, const char_T *c3_identifier, char_T c3_y[14]);
static void c3_f_emlrt_marshallIn(SFc3_huamoInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, char_T c3_y[14]);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_g_emlrt_marshallIn(SFc3_huamoInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_h_emlrt_marshallIn(SFc3_huamoInstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_huamo, const char_T *c3_identifier);
static uint8_T c3_i_emlrt_marshallIn(SFc3_huamoInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_eml_xgemm(SFc3_huamoInstanceStruct *chartInstance, real_T c3_A
  [16], real_T c3_B[4], real_T c3_C[4]);
static void init_dsm_address_info(SFc3_huamoInstanceStruct *chartInstance);
...
static void initialize_c3_huamo(SFc3_huamoInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_huamo = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_huamo;
  ...
  const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_huamo = c3_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 1)), "is_active_c3_huamo");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_huamo(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u[4];
  const mxArray *c3_y = NULL;
  SFc3_huamoInstanceStruct *chartInstance;
  chartInstance = (SFc3_huamoInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_huamo_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c3_b_is_active_c3_huamo, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_is_active_c3_huamo),
    &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_huamo);
  return c3_y;
}
...
void sf_c3_huamo_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_huamo_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_huamo_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_huamo_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_huamo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[8],M[0],T\"is_active_c3_huamo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_huamo_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_huamoInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c3_huamo(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_huamoInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c3_huamo((SFc3_huamoInstanceStruct*) chartInstanceVar);
  initialize_c3_huamo((SFc3_huamoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_huamo(void *chartInstanceVar)
{
  enable_c3_huamo((SFc3_huamoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_huamo(void *chartInstanceVar)
{
  disable_c3_huamo((SFc3_huamoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_huamo(void *chartInstanceVar)
{
  sf_gateway_c3_huamo((SFc3_huamoInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_huamo(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_huamo((SFc3_huamoInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_huamo();/* state var info */
...
extern void sf_internal_set_sim_state_c3_huamo(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_huamo();/* state var info */
  ...
  set_sim_state_c3_huamo((SFc3_huamoInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_huamo(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_huamo(S);
}

static void sf_opaque_set_sim_state_c3_huamo(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_huamo(S, st);
}

static void sf_opaque_terminate_c3_huamo(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_huamoInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_huamo((SFc3_huamoInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_huamo((SFc3_huamoInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_huamo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_huamo((SFc3_huamoInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_huamo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_huamo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_huamo(SimStruct *S)
{
  SFc3_huamoInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_huamoInstanceStruct *)utMalloc(sizeof
    (SFc3_huamoInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_huamoInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_huamo;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_huamo;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_huamo;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_huamo;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_huamo;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_huamo;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_huamo;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_huamo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_huamo;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_huamo;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_huamo;
...
void c3_huamo_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_huamo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_huamo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_huamo_method_dispatcher.\n"
