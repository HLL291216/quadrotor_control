...
void download_IMU(void)
{
  ...
  if (download_B.angle_o1 > 0) {
    /* Inport: '<S56>/yaw_H' */
    download_B.yaw_H = download_B.angle_o2;

    /* Inport: '<S56>/yaw_L' */
    download_B.yaw_L = download_B.angle_o3;
     ...
     */
    rtb_Add = (uint16_T)((uint32_T)(download_B.yaw_H << 8) + download_B.yaw_L);

    /* Inport: '<S56>/pitch_H' */
    download_B.pitch_H = download_B.angle_o4;

    /* Inport: '<S56>/pitch_L' */
    download_B.pitch_L = download_B.angle_o5;
     ...
     */
    rtb_Add1 = (uint16_T)((uint32_T)(download_B.pitch_H << 8) +
                          download_B.pitch_L);

    /* Inport: '<S56>/roll_H' */
    download_B.roll_H = download_B.angle_o6;

    /* Inport: '<S56>/roll_L' */
    download_B.roll_L = download_B.angle_o7;
     ...
     */
    rtb_Add2 = (uint16_T)((uint32_T)(download_B.roll_H << 8) + download_B.roll_L);

    /* Inport: '<S56>/p_H' */
    download_B.p_H = download_B.angle_o8;

    /* Inport: '<S56>/p_L' */
    download_B.p_L = download_B.angle_o9;
     ...
     */
    rtb_Add3 = (uint16_T)((uint32_T)(download_B.p_H << 8) + download_B.p_L);

    /* Inport: '<S56>/q_H' */
    download_B.q_H = download_B.angle_o10;

    /* Inport: '<S56>/q_L' */
    download_B.q_L = download_B.angle_o11;
     ...
     */
    rtb_Add4 = (uint16_T)((uint32_T)(download_B.q_H << 8) + download_B.q_L);

    /* Inport: '<S56>/r_H' */
    download_B.r_H = download_B.angle_o12;

    /* Inport: '<S56>/r_L' */
    download_B.r_L = download_B.angle_o13;
     ...
     */
    rtb_Add5 = (uint16_T)((uint32_T)(download_B.r_H << 8) + download_B.r_L);

    /* Inport: '<S56>/alt_H' */
    download_B.alt_H = download_B.angle_o14;

    /* Inport: '<S56>/alt_L' */
    download_B.alt_L = download_B.angle_o15;
     ...
     */
    rtb_Add6 = (uint16_T)((uint32_T)(download_B.alt_H << 8) + download_B.alt_L);
     ...
     *  Sum: '<S57>/Sum'
     */
    if ((rtb_Add & download_P.BitwiseOperator2_BitMask) >
     ...
     */
    download_B.Gain_n = download_P.Gain_Gain_o * (real32_T)(int16_T)rtb_Add;
     ...
     *  Sum: '<S58>/Sum'
     */
    if ((rtb_Add1 & download_P.BitwiseOperator2_BitMask_i) >
     ...
     */
    download_B.Gain1_b = download_P.Gain1_Gain_d * (real32_T)(int16_T)rtb_Add1;
     ...
     *  Sum: '<S59>/Sum'
     */
    if ((rtb_Add2 & download_P.BitwiseOperator2_BitMask_k) >
        download_P.Switch_Threshold_jy) {
     ...
     */
    download_B.Gain2_e = download_P.Gain2_Gain_o * (real32_T)(int16_T)rtb_Add2;
     ...
     *  Sum: '<S60>/Sum'
     */
    if ((rtb_Add3 & download_P.BitwiseOperator2_BitMask_a) >
     ...
     */
    download_B.Gain3_m = download_P.Gain3_Gain_l * (real32_T)(int16_T)rtb_Add3;
     ...
     *  Sum: '<S61>/Sum'
     */
    if ((rtb_Add4 & download_P.BitwiseOperator2_BitMask_i0) >
     ...
     */
    download_B.Gain4_n = download_P.Gain4_Gain_m * (real32_T)(int16_T)rtb_Add4;
     ...
     *  Sum: '<S62>/Sum'
     */
    if ((rtb_Add5 & download_P.BitwiseOperator2_BitMask_m) >
     ...
     */
    download_B.Gain5 = download_P.Gain5_Gain_h * (real32_T)(int16_T)rtb_Add5;
